...
> - Cas 1 : on conserve le plus d'information possible, en supprimant néanmoins les données à caractère personel. La preudonymisation sera par exemple : *"Monsieur X. est accusé d'avoir cambriolé l'établissement "Café XXX" à Gentioux-Pigerolles, en Creuse, situé en face de son domicile, et d'avoir dérobé la recette de la semaine évaluée à 1000€"*. Le problème, c'est que s'il n'y a qu'un seul café dans ce petit village, il est très aisé de comprendre de quel établissement on parle, de sa localisation et donc celle du domicile de l'accusé, et ainsi de réidentifier ce dernier si l'on est familier du village. La preudonymisation est donc inutile et ne protège pas suffisamment les données à caractère personnel.
